          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                Bridging <span className="text-primary glow-text">The Gap</span>
                <br />
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/miguelsumo" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/miguel-sumo/" },
                { icon: Instagram, href: "https://www.instagram.com/miguelsumo_/" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
